...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText1: 'Showing all {0}',                                                        // text when all options 1 are visible / false for no info text
      infoText2: 'Showing all {0}',                                                        // text when all options 2 are visible / false for no info text
  ...
  function refreshInfo(dualListbox) {
    if (!dualListbox.settings.infoText1) {
      return;
    }
    if (!dualListbox.settings.infoText2) {
      return;
    }
    ...
    if (all1 === 0) {
      ...
      content = formatString(dualListbox.settings.infoText1, [visible1, all1]);
    } else {
  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.setInfoText(this.settings.infoText1, this.settings.infoText2);
    ...
    setInfoText: function(value1, value2, refresh) {
      this.settings.infoText1 = value1;
      this.settings.infoText2 = value2;
      if (value1 && value2) {
