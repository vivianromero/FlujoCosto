    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confconsec', django_choices_field.fields.IntegerChoicesField(choices=[(1, 'Por departamento y tipo de documento'), (2, 'Por departamento'), (3, 'Por tipo de documento'), (4, 'Unico en el sistema')], choices_enum=codificadores.models.ConfigNumero, db_comment='Para guardar el tipo de conf para el consecutivo y poder establecer la constarint', default=1)),
                ('confcontrol', django_choices_field.fields.IntegerChoicesField(choices=[(1, 'Por departamento y tipo de documento'), (2, 'Por departamento'), (3, 'Por tipo de documento'), (4, 'Unico en el sistema')], choices_enum=codificadores.models.ConfigNumero, db_comment='Para guardar el tipo de conf para el numero de control y poder establecer la constarint', default=1)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(condition=models.Q(('confconsec', 1)), fields=('numeroconsecutivo', 'departamento', 'tipodocumento', 'mes', 'anno', 'ueb'), name='unique_numeroconsecutivo_departamento_tipodocumento'),
        ),
        migrations.AddConstraint(
            model_name='documento',
            constraint=models.UniqueConstraint(condition=models.Q(('confconsec', 2)), fields=('numeroconsecutivo', 'departamento', 'mes', 'anno', 'ueb'), name='unique_numeroconsecutivo_departamento'),
        ),
        migrations.AddConstraint(
            model_name='documento',
            constraint=models.UniqueConstraint(condition=models.Q(('confconsec', 3)), fields=('numeroconsecutivo', 'tipodocumento', 'mes', 'anno', 'ueb'), name='unique_numeroconsecutivo_tipodocumento'),
        ),
        migrations.AddConstraint(
            model_name='documento',
            constraint=models.UniqueConstraint(condition=models.Q(('confconsec', 4)), fields=('numeroconsecutivo', 'mes', 'anno', 'ueb'), name='unique_numeroconsecutivo_ueb'),
        ),
        migrations.AddConstraint(
            model_name='documento',
            constraint=models.UniqueConstraint(condition=models.Q(('confcontrol', 1)), fields=('numerocontrol', 'departamento', 'tipodocumento', 'anno', 'ueb'), name='unique_numerocontrol_departamento_tipodocumento'),
        ),
        migrations.AddConstraint(
            model_name='documento',
            constraint=models.UniqueConstraint(condition=models.Q(('confcontrol', 2)), fields=('numerocontrol', 'departamento', 'anno', 'ueb'), name='unique_numerocontrol_departamento'),
        ),
        migrations.AddConstraint(
            model_name='documento',
            constraint=models.UniqueConstraint(condition=models.Q(('confcontrol', 3)), fields=('numerocontrol', 'tipodocumento', 'anno', 'ueb'), name='unique_numerocontrol_tipodocumento'),
        ),
        migrations.AddConstraint(
            model_name='documento',
            constraint=models.UniqueConstraint(condition=models.Q(('confcontrol', 4)), fields=('numerocontrol', 'anno', 'ueb'), name='unique_numerocontrol_ueb'),
        ),
        migrations.AddConstraint(
