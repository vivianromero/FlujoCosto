    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(editable=False)),
                ('filasasumar', models.ManyToManyField(db_comment='Filas encabezadas que se suman', related_name='sumafilasficha', to='codificadores.fichacostofilas', verbose_name='Filas a sumar')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vinculo_produccion', models.SmallIntegerField(choices=[(1, 'Directo'), (2, 'Indirecto Producción'), (3, 'Indirecto')], db_comment='Directo (1), Indirecto Producción (2), Indirecto (3)', default=1, verbose_name='Vinculo Producción')),
