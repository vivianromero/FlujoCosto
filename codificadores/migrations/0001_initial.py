    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operacion', django_choices_field.fields.TextChoicesField(choices=[('E', 'Entrada'), ('S', 'Salida')], choices_enum=codificadores.models.OperacionDocumento, db_comment='Operación de Entrada (E) o Salida (S)', max_length=1, verbose_name='Operación')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('centrocosto', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='departamento_centrocosto', to='codificadores.centrocosto', unique=True, verbose_name='Cost Center')),
                ...
                ('departamentoproductoentrada', models.ManyToManyField(blank=True, null=True, related_name='departamentoproductoentrada_producto', to='codificadores.productodepartamento', verbose_name='Productos de Entrada')),
                ('departamentoproductosalida', models.ManyToManyField(blank=True, null=True, related_name='departamentoproductosalida_producto', to='codificadores.productodepartamento', verbose_name='Output Products')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(editable=False)),
                ('filasasumar', models.ManyToManyField(blank=True, db_comment='Filas encabezadas que se suman', null=True, related_name='sumafilasficha', to='codificadores.fichacostofilas', verbose_name='Filas a sumar')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('destino', django_choices_field.fields.TextChoicesField(choices=[('C', 'Consumo Nacional'), ('E', 'Exportación')], choices_enum=codificadores.models.Destino, max_length=1, verbose_name='Destination')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actividad', django_choices_field.fields.TextChoicesField(choices=[('C', 'Consumo Nacional'), ('E', 'Exportación')], choices_enum=codificadores.models.Destino, max_length=1, verbose_name='Actividad')),
                ('vinculo_produccion', django_choices_field.fields.IntegerChoicesField(choices=[(1, 'Directo'), (2, 'Indirecto Producción'), (3, 'Indirecto')], choices_enum=codificadores.models.VinculoCargoProduccion, db_comment='Directo (1), Indirecto Producción (2), Indirecto (3)', default=1, verbose_name='Vinculo Producción')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipovitola', django_choices_field.fields.IntegerChoicesField(choices=[(1, 'Picadura'), (2, 'Hoja')], choices_enum=codificadores.models.TipoVitola, verbose_name='Type')),
