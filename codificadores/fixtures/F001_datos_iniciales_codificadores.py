...
def init_data(apps, schema_editor):
    ...
    clasemp = [
        ClaseMateriaPrima(pk=ChoiceClasesMatPrima.CAPOTE, descripcion=ChoiceClasesMatPrima.CHOICE_CLASES[ChoiceClasesMatPrima.CAPOTE], capote_fortaleza='C'),
        ClaseMateriaPrima(pk=ChoiceClasesMatPrima.F1, descripcion=ChoiceClasesMatPrima.CHOICE_CLASES[ChoiceClasesMatPrima.F1], capote_fortaleza='F'),
        ClaseMateriaPrima(pk=ChoiceClasesMatPrima.F2, descripcion=ChoiceClasesMatPrima.CHOICE_CLASES[ChoiceClasesMatPrima.F2], capote_fortaleza='F'),
        ClaseMateriaPrima(pk=ChoiceClasesMatPrima.F3, descripcion=ChoiceClasesMatPrima.CHOICE_CLASES[ChoiceClasesMatPrima.F3], capote_fortaleza='F'),
        ClaseMateriaPrima(pk=ChoiceClasesMatPrima.CAPACLASIFICADA, descripcion=ChoiceClasesMatPrima.CHOICE_CLASES[ChoiceClasesMatPrima.CAPACLASIFICADA], capote_fortaleza='P'),
        ClaseMateriaPrima(pk=ChoiceClasesMatPrima.CAPASINCLASIFICAR, descripcion=ChoiceClasesMatPrima.CHOICE_CLASES[ChoiceClasesMatPrima.CAPASINCLASIFICAR], capote_fortaleza='P'),
        ClaseMateriaPrima(pk=ChoiceClasesMatPrima.F4, descripcion=ChoiceClasesMatPrima.CHOICE_CLASES[ChoiceClasesMatPrima.F4], capote_fortaleza='F'),
    ]
    act_model_clasemateriaprima.objects.bulk_create(clasemp)

    categvit = [
        CategoriaVitola(pk=ChoiceCategoriasVit.IX,descripcion=ChoiceCategoriasVit.CHOICE_CATEGORIAS[ChoiceCategoriasVit.IX],orden=5),
        CategoriaVitola(pk=ChoiceCategoriasVit.V,descripcion=ChoiceCategoriasVit.CHOICE_CATEGORIAS[ChoiceCategoriasVit.V],orden=1),
        CategoriaVitola(pk=ChoiceCategoriasVit.VI,descripcion=ChoiceCategoriasVit.CHOICE_CATEGORIAS[ChoiceCategoriasVit.VI],orden=2),
        CategoriaVitola(pk=ChoiceCategoriasVit.VII,descripcion=ChoiceCategoriasVit.CHOICE_CATEGORIAS[ChoiceCategoriasVit.VII],orden=3),
        CategoriaVitola(pk=ChoiceCategoriasVit.VIII,descripcion=ChoiceCategoriasVit.CHOICE_CATEGORIAS[ChoiceCategoriasVit.VIII],orden=4),
    ]
    act_model_categoriavitola.objects.bulk_create(categvit)

    tipovitola = [
        TipoVitola(pk=ChoiceTiposVitola.PICADURA,descripcion=ChoiceTiposVitola.CHOICE_TIPOS_VITOLA[ChoiceTiposVitola.PICADURA]),
        TipoVitola(pk=ChoiceTiposVitola.HOJA,descripcion=ChoiceTiposVitola.CHOICE_TIPOS_VITOLA[ChoiceTiposVitola.HOJA]),
    ]
    act_model_tipovitola.objects.bulk_create(tipovitola)

    motivoajuste = [
        MotivoAjuste(pk=ChoiceMotivosAjuste.MERMA, descripcion=ChoiceMotivosAjuste.CHOICE_MOTIVOS_AJUSTE[ChoiceMotivosAjuste.MERMA], aumento=False, activo=True),
        MotivoAjuste(pk=ChoiceMotivosAjuste.ROTURA, descripcion=ChoiceMotivosAjuste.CHOICE_MOTIVOS_AJUSTE[ChoiceMotivosAjuste.ROTURA], aumento=False, activo=True),
        MotivoAjuste(pk=ChoiceMotivosAjuste.PROMOCION, descripcion=ChoiceMotivosAjuste.CHOICE_MOTIVOS_AJUSTE[ChoiceMotivosAjuste.PROMOCION], aumento=False, activo=True),
        MotivoAjuste(pk=ChoiceMotivosAjuste.SUBPRODUCTOS, descripcion=ChoiceMotivosAjuste.CHOICE_MOTIVOS_AJUSTE[ChoiceMotivosAjuste.SUBPRODUCTOS], aumento=False, activo=True),
    ]
    act_model_motivoajuste.objects.bulk_create(motivoajuste)

    tipodoc = [
        TipoDocumento(pk=ChoiceTiposDoc.ENTRADA_DESDE_VERSAT, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.ENTRADA_DESDE_VERSAT], operacion='E', generado=True),
        TipoDocumento(pk=ChoiceTiposDoc.SALIDA_HACIA_VERSAT, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.SALIDA_HACIA_VERSAT], operacion='S', generado=True),
        TipoDocumento(pk=ChoiceTiposDoc.TRANSF_HACIA_DPTO, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.TRANSF_HACIA_DPTO], operacion='S', generado=False),
        TipoDocumento(pk=ChoiceTiposDoc.TRANSF_DESDE_DPTO, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.TRANSF_DESDE_DPTO], operacion='E', generado=True),
        TipoDocumento(pk=ChoiceTiposDoc.AJUSTE_AUMENTO, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.AJUSTE_AUMENTO], operacion='E', generado=False),
        TipoDocumento(pk=ChoiceTiposDoc.AJUSTE_DISMINUCION, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.AJUSTE_DISMINUCION], operacion='S', generado=False),
        TipoDocumento(pk=ChoiceTiposDoc.RECEPCION_PRODUCCION_REPROCESO, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.RECEPCION_PRODUCCION_REPROCESO], operacion='E', generado=False),
        TipoDocumento(pk=ChoiceTiposDoc.RECEPCION_PRODUCCION, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.RECEPCION_PRODUCCION], operacion='E', generado=False),
        TipoDocumento(pk=ChoiceTiposDoc.DEVOLUCION, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.DEVOLUCION], operacion='S', generado=False),
        TipoDocumento(pk=ChoiceTiposDoc.SOBRANTE_SUJETO_INVESTIGACION, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.SOBRANTE_SUJETO_INVESTIGACION], operacion='E', generado=False),
        TipoDocumento(pk=ChoiceTiposDoc.RECEPCION_RECHAZO, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.RECEPCION_RECHAZO], operacion='E', generado=False),
        TipoDocumento(pk=ChoiceTiposDoc.CARGA_INICIAL, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.CARGA_INICIAL], operacion='E', generado=False),
        TipoDocumento(pk=ChoiceTiposDoc.DEVOLUCION_RECIBIDA, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.DEVOLUCION_RECIBIDA], operacion='E', generado=True),
        TipoDocumento(pk=ChoiceTiposDoc.CAMBIO_ESTADO, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.CAMBIO_ESTADO], operacion='S', generado=False),
        TipoDocumento(pk=ChoiceTiposDoc.TRANSFERENCIA_EXTERNA, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.TRANSFERENCIA_EXTERNA], operacion='S', generado=False),
        TipoDocumento(pk=ChoiceTiposDoc.RECIBIR_TRANS_EXTERNA, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.RECIBIR_TRANS_EXTERNA], operacion='E', generado=False),
        TipoDocumento(pk=ChoiceTiposDoc.VENTA_TRABAJADORES, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.VENTA_TRABAJADORES], operacion='S', generado=False),
        TipoDocumento(pk=ChoiceTiposDoc.REPORTE_SUBPRODUCTOS, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.REPORTE_SUBPRODUCTOS], operacion='E', generado=False),
        TipoDocumento(pk=ChoiceTiposDoc.CAMBIO_PRODUCTO, descripcion=ChoiceTiposDoc.CHOICE_TIPOS_DOC[ChoiceTiposDoc.CAMBIO_PRODUCTO], operacion='S', generado=False),
    ]
    act_model_tipodocumento.objects.bulk_create(tipodoc)

    numdoc = [
        NumeracionDocumentos(pk=ChoiceTipoNumeroDoc.NUMERO_CONSECUTIVO, tiponumeracion=ChoiceTipoNumeroDoc.NUMERO_CONSECUTIVO, sistema=True, departamento=True, tipo_documento=True, prefijo=False),
        NumeracionDocumentos(pk=ChoiceTipoNumeroDoc.NUMERO_CONTROL, tiponumeracion=ChoiceTipoNumeroDoc.NUMERO_CONTROL, sistema=False, departamento=True, tipo_documento=True, prefijo=False),
    ]
    ...
    ucontab = [
        ...
        UnidadContable(pk="409d9e9f-4064-4214-a051-a1f78ea36b65", codigo="19", nombre="UEB COMERCIALIZADORA", is_comercializadora=True),
        UnidadContable(pk="809d9e9f-4064-4214-a051-a1f78ea26b65", codigo="21", nombre="DIRECCION DE EMPRESA", is_empresa=True),
    ...
    confccelem = [
        ConfCentrosElementosOtros(pk=ChoiceConfCentrosElementosOtros.CENTROSCOSTO, clave=ChoiceConfCentrosElementosOtros.CHOICE_CONF_CC_ELEM_OTROS[ChoiceConfCentrosElementosOtros.CENTROSCOSTO]),
        ConfCentrosElementosOtros(pk=ChoiceConfCentrosElementosOtros.ELEMENTOSGASTO, clave=ChoiceConfCentrosElementosOtros.CHOICE_CONF_CC_ELEM_OTROS[ChoiceConfCentrosElementosOtros.ELEMENTOSGASTO]),
    ]
    ...
    confccelemdetalles = [
        ...
        ConfCentrosElementosOtrosDetalle(pk=9, clave=act_model_confccelem_eg, descripcion='Traspasos de Costos de Calidad'),
    ]
    ...
    parent = FichaCostoFilas.objects.create(pk=1, fila='1', descripcion="Gasto Material", encabezado=True)
    FichaCostoFilas.objects.create(pk=2, fila='1.1', descripcion="Materia Prima y Materiales", parent=parent, desglosado=True)
    FichaCostoFilas.objects.create(pk=3, fila='1.2', descripcion="Gastos Materia Prima Tabaco", parent=parent,
                                   desglosado=True)